                  ...
                  >
                    <div className="qs-row">
                      <div className="qs-row-label">
                        ...
                        <span
                          className="qs-info-icon"
                          title="自动切号引擎搭载了 4 层智能防御体系：&#10;&#10;① 动态侦测提频：依据配额余量动态调优探测间隔，配额越低刷得越快，极限自动加速至 30s。&#10;② 衰减速率预判：若系统推演依照当前消耗斜率在 90s 内即将宕机，将直接实施提前拦截切号。&#10;③ 紧急熔断恢复：一旦底层遭遇 429 限流阻断报错，瞬时捕获并强制切换。&#10;④ 用户阈值兜底：跌至您设定的安全百分比时将作为底线触发。&#10;&#10;💡 综上，推荐放心设为 0%。系统会在保障开发平顺性前提下，为您榨干每一滴免费配额！"
                        >
                          !
                        </span>
                      </div>
